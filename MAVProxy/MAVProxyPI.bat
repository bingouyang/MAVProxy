...
python .\MAVProxy\mavproxy.py --master=udp:127.0.0.1:14550 --out=udpout:10.113.51.25:14551 --out=udpin:0.0.0.0:14555 --out=udp:127.0.0.1:14560 --aircraft=splashy --console --cmd "set moddebug 3"
